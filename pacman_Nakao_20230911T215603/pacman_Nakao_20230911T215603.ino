...
int i,game = 0;
uint16_t pinAbsROW[8] =  {10,13,15, 4, 5, 2,26,32};  //点灯時アノード,ESP32のピン番号
uint16_t pinAbsCol0[8] = { 9,12,15, 0, 6, 3, 0,33}; //赤,点灯時カソード,IOエキスパンダのピン番号
uint16_t pinAbsCol1[8] = { 8,11,14, 2, 7, 4, 1,25};  //黄,点灯時カソード,IOエキスパンダのピン番号
